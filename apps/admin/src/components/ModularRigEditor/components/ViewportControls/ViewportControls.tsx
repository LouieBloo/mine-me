...
import { MODULAR_ANIMATION_STATES } from '@mine-me/shared';
import './ViewportControls.css';

export interface ViewportControlsProps {
  animState: ModularAnimationState;
  setAnimState: (state: ModularAnimationState) => void;
    ...
    <div className="viewport-controls-container w-full space-y-3">
      ...
      <div className="w-full pt-4 border-t border-slate-100 flex flex-col gap-2">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          {MODULAR_ANIMATION_STATES.map((state) => (
            <button
              key={state}
